...
let rec _menhir_goto_nonemptystack : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.remplacement) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    match _menhir_s with
    | MenhirState32 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (rempl : (Ast.remplacement)) = _v in
...
# 65 "parser.ml"
        ...
        let _2 = () in
        let _v : (Ast.remplacement) = 
# 58 "parser.mly"
                                              (Remplace(Symbol(Lettre(l1)), rempl))
# 71 "parser.ml"
         in
...
and _menhir_goto_stack : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.remplacement) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
...
# 6 "parser.mly"
      (string)
# 109 "parser.ml"
        ))), _, (s : (Ast.remplacement))) = _menhir_stack in
        let _11 = () in
        let _9 = () in
        let _7 = () in
        let _5 = () in
...
# 46 "parser.mly"
                                                                                                   (Transition(Symbol(Lettre(l1)), Symbol(l2), Symbol(Lettre(l3)), Symbol(Lettre(l4)), s))
# 120 "parser.ml"
         in
        let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
        let _menhir_stack = Obj.magic _menhir_stack in
...
# 194 "parser.ml"
        ...
        | EOF ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
            let ((_menhir_stack, (d : (Ast.declaration))), (t : (Ast.transition list))) = _menhir_stack in
            let _3 = () in
            let _v : (
# 8 "parser.mly"
      (Ast.automate)
...
# 220 "parser.ml"
    ...
    | MenhirState38 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (suite : (Ast.transition list)) = _v in
...
and _menhir_goto_lettre_ou_vide : _menhir_env -> 'ttv_tail -> (Ast.lettre_ou_vide) -> 'ttv_return =
...
and _menhir_goto_suitelettres_nonvide : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.inputsymbols) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    match _menhir_s with
    | MenhirState3 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (suite : (Ast.inputsymbols)) = _v in
        let (_menhir_stack, _menhir_s, (l : (
# 6 "parser.mly"
      (string)
# 405 "parser.ml"
...
# 534 "parser.ml"
                        ...
                        let _menhir_stack = Obj.magic _menhir_stack in
                        let _menhir_stack = Obj.magic _menhir_stack in
                        let (init_stack : (Ast.stacksymbol)) = _v in
                        let ((((_menhir_stack, (input_s : (Ast.inputsymbols))), (stack_s : (Ast.inputsymbols))), (s : (Ast.inputsymbols))), (init_state : (Ast.state))) = _menhir_stack in
                        let _v : (Ast.declaration) = 
# 17 "parser.mly"
                                                                                                       (Declaration (input_s, stack_s, s, init_state, init_stack))
# 543 "parser.ml"
                         in
                        let _menhir_stack = (_menhir_stack, _v) in
                        let _menhir_stack = Obj.magic _menhir_stack in
